...
function App(props) {
  ...
  return (
    <div className="App">
      ...
      <Parallax  className='bg-video' autoPlay={true} playsInline="" loop={true} muted={true} >
      <video  className='bg-video' autoPlay={true} playsInline="" loop={true} muted={true}style={{display: "block"}} data-bm="42">
